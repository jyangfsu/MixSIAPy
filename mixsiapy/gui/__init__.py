...
def main():
    ...
    try:
        ...
        raise SystemExit(
            ...
            "python -m pip install 'mixsiapy[gui,bayes]'"
        ) from exc
...
def _render_script(c):
    ...
    return f'''"""Automatically exported by the MixSIAPy GUI."""
from pathlib import Path
from mixsiapy import load_mix_data, load_source_data, load_discr_data, run_model, save_results
