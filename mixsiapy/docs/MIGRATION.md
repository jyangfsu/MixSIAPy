...
The supported implementation lives in `mixsiapy/`. Early Python prototypes have been removed from the distributable repository; `reference_r/` is a frozen copy of MixSIAR 3.1.12 used to compare behavior.
