...
The complete reproducible validation suite is under `benchmarks/`. It covers cross-language numerical agreement, CPU-backend performance, and CPU-GPU scaling. See `benchmarks/README.md` for the workflow, dependencies, and acceptance criteria.
