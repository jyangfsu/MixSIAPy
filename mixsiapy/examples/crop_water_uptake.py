...
example jointly estimates species-specific biomass and planting-diversity
relationships while accounting for variation among planting compositions.
...
# Generalized ILR composition model. Each ``*`` expands to both main effects
# and their interaction, allowing biomass and diversity relationships to vary
# among crop species within a single Bayesian mixing model.
